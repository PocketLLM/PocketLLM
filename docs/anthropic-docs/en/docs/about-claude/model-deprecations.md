# Model deprecations - Claude Docs> Source: https://docs.claude.com/en/docs/about-claude/model-deprecationsAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
On this page
  * [Overview](https://docs.claude.com/en/docs/about-claude/model-deprecations#overview)
  * [Migrating to replacements](https://docs.claude.com/en/docs/about-claude/model-deprecations#migrating-to-replacements)
  * [Notifications](https://docs.claude.com/en/docs/about-claude/model-deprecations#notifications)
  * [Auditing model usage](https://docs.claude.com/en/docs/about-claude/model-deprecations#auditing-model-usage)
  * [Best practices](https://docs.claude.com/en/docs/about-claude/model-deprecations#best-practices)
  * [Deprecation downsides and mitigations](https://docs.claude.com/en/docs/about-claude/model-deprecations#deprecation-downsides-and-mitigations)
  * [Model status](https://docs.claude.com/en/docs/about-claude/model-deprecations#model-status)
  * [Deprecation history](https://docs.claude.com/en/docs/about-claude/model-deprecations#deprecation-history)
  * [2025-10-28: Claude Sonnet 3.7 model](https://docs.claude.com/en/docs/about-claude/model-deprecations#2025-10-28%3A-claude-sonnet-3-7-model)
  * [2025-08-13: Claude Sonnet 3.5 models](https://docs.claude.com/en/docs/about-claude/model-deprecations#2025-08-13%3A-claude-sonnet-3-5-models)
  * [2025-06-30: Claude Opus 3 model](https://docs.claude.com/en/docs/about-claude/model-deprecations#2025-06-30%3A-claude-opus-3-model)
  * [2025-01-21: Claude 2, Claude 2.1, and Claude Sonnet 3 models](https://docs.claude.com/en/docs/about-claude/model-deprecations#2025-01-21%3A-claude-2%2C-claude-2-1%2C-and-claude-sonnet-3-models)
  * [2024-09-04: Claude 1 and Instant models](https://docs.claude.com/en/docs/about-claude/model-deprecations#2024-09-04%3A-claude-1-and-instant-models)
...
## 
[​](https://docs.claude.com/en/docs/about-claude/model-deprecations#overview)
Overview
...
## 
[​](https://docs.claude.com/en/docs/about-claude/model-deprecations#auditing-model-usage)
...
## 
[​](https://docs.claude.com/en/docs/about-claude/model-deprecations#best-practices)
Best practices
...
## 
[​](https://docs.claude.com/en/docs/about-claude/model-deprecations#deprecation-downsides-and-mitigations)
...
## 
[​](https://docs.claude.com/en/docs/about-claude/model-deprecations#deprecation-history)
Deprecation history
All deprecations are listed below, with the most recent announcements at the top.
### 
[​](https://docs.claude.com/en/docs/about-claude/model-deprecations#2025-10-28%3A-claude-sonnet-3-7-model)
2025-10-28: Claude Sonnet 3.7 model
On October 28, 2025, we notified developers using Claude Sonnet 3.7 model of its upcoming retirement on the Claude API. Retirement Date | Deprecated Model | Recommended Replacement  
---|---|---  
...
### 
[​](https://docs.claude.com/en/docs/about-claude/model-deprecations#2025-06-30%3A-claude-opus-3-model)
...
### 
[​](https://docs.claude.com/en/docs/about-claude/model-deprecations#2025-01-21%3A-claude-2%2C-claude-2-1%2C-and-claude-sonnet-3-models)
2025-01-21: Claude 2, Claude 2.1, and Claude Sonnet 3 models
These models were retired July 21, 2025.
On January 21, 2025, we notified developers using Claude 2, Claude 2.1, and Claude Sonnet 3 models of their upcoming retirements. Retirement Date | Deprecated Model | Recommended Replacement  
---|---|---  
...
### 
[​](https://docs.claude.com/en/docs/about-claude/model-deprecations#2024-09-04%3A-claude-1-and-instant-models)
...
YesNo
[Migrating to Claude 4.5](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4)[Pricing](https://docs.claude.com/en/docs/about-claude/pricing)
Assistant
