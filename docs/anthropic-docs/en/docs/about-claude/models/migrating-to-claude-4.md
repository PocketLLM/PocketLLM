# Migrating to Claude 4.5 - Claude Docs> Source: https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4Agent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
On this page
  * [Migrating from Claude Sonnet 3.7 to Claude Sonnet 4.5](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#migrating-from-claude-sonnet-3-7-to-claude-sonnet-4-5)
  * [Migration steps](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#migration-steps)
  * [Sonnet 3.7 → 4.5 migration checklist](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#sonnet-3-7-%E2%86%92-4-5-migration-checklist)
  * [Features removed from Claude Sonnet 3.7](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#features-removed-from-claude-sonnet-3-7)
  * [Migrating from Claude Haiku 3.5 to Claude Haiku 4.5](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#migrating-from-claude-haiku-3-5-to-claude-haiku-4-5)
  * [Migration steps](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#migration-steps-2)
  * [Haiku 3.5 → 4.5 migration checklist](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#haiku-3-5-%E2%86%92-4-5-migration-checklist)
  * [Choosing between Sonnet 4.5 and Haiku 4.5](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#choosing-between-sonnet-4-5-and-haiku-4-5)
  * [Choose Claude Sonnet 4.5 (most intelligent) for:](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#choose-claude-sonnet-4-5-most-intelligent-for%3A)
  * [Choose Claude Haiku 4.5 (fastest and most intelligent Haiku) for:](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#choose-claude-haiku-4-5-fastest-and-most-intelligent-haiku-for%3A)
  * [Extended thinking recommendations](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#extended-thinking-recommendations)
  * [Other migration scenarios](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#other-migration-scenarios)
  * [Migrating from Claude Sonnet 4 → Sonnet 4.5](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#migrating-from-claude-sonnet-4-%E2%86%92-sonnet-4-5)
  * [Migrating from Claude Opus 4.1 → Sonnet 4.5](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#migrating-from-claude-opus-4-1-%E2%86%92-sonnet-4-5)
  * [Need help?](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#need-help%3F)
...
Both migrations involve breaking changes that require updates to your implementation. This guide will walk you through each migration path with step-by-step instructions and clearly marked breaking changes. Before starting your migration, we recommend reviewing [What’s new in Claude 4.5](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5) to understand the new features and capabilities available in these models, including extended thinking, context awareness, and behavioral improvements.
## 
[​](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#migrating-from-claude-sonnet-3-7-to-claude-sonnet-4-5)
...
### 
[​](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#migration-steps)
Migration steps
...
```
  ...
  3. **Handle the new`refusal` stop reason** Update your application to [handle `refusal` stop reasons](https://docs.claude.com/en/docs/test-and-evaluate/strengthen-guardrails/handle-streaming-refusals):
Copy
```
response = client.messages.create(...)
...
See [Text editor tool documentation](https://docs.claude.com/en/docs/agents-and-tools/tool-use/text-editor-tool) for details.
  ...
  6. **Remove token-efficient tool use beta header** [Token-efficient tool use](https://docs.claude.com/en/docs/agents-and-tools/tool-use/token-efficient-tool-use) is a beta feature that only works with Claude 3.7 Sonnet. All Claude 4 models have built-in token-efficient tool use, so you should no longer include the beta header. Remove the `token-efficient-tools-2025-02-19` [beta header](https://docs.claude.com/en/api/beta-headers) from your requests:
Copy
```
# Before (Claude Sonnet 3.7)
...
```
  ...
  7. **Remove extended output beta header** The `output-128k-2025-02-19` [beta header](https://docs.claude.com/en/api/beta-headers) for extended output is only available in Claude Sonnet 3.7. Remove this header from your requests:
Copy
```
# Before (Claude Sonnet 3.7)
client.messages.create(
...
```
  ...
  8. **Update your prompts for behavioral changes** Claude Sonnet 4.5 has a more concise, direct communication style and requires explicit direction. Review [Claude 4 prompt engineering best practices](https://docs.claude.com/en/docs/build-with-claude/prompt-engineering/claude-4-best-practices) for optimization guidance.
  9. **Consider enabling extended thinking for complex tasks** Enable [extended thinking](https://docs.claude.com/en/docs/build-with-claude/extended-thinking) for significant performance improvements on coding and reasoning tasks (disabled by default):
Copy
```
response = client.messages.create(
    model="claude-sonnet-4-5-20250929",
...
Extended thinking impacts [prompt caching](https://docs.claude.com/en/docs/build-with-claude/prompt-caching#caching-with-thinking-blocks) efficiency.
...
### 
[​](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#sonnet-3-7-%E2%86%92-4-5-migration-checklist)
Sonnet 3.7 → 4.5 migration checklist
  ...
  * Review and update prompts following [Claude 4 best practices](https://docs.claude.com/en/docs/build-with-claude/prompt-engineering/claude-4-best-practices)
...
### 
[​](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#features-removed-from-claude-sonnet-3-7)
...
```
  ...
  4. **Review new rate limits** Haiku 4.5 has separate rate limits from Haiku 3.5. See [Rate limits documentation](https://docs.claude.com/en/api/rate-limits) for details.
  5. **Handle the new`refusal` stop reason** Update your application to [handle refusal stop reasons](https://docs.claude.com/en/docs/test-and-evaluate/strengthen-guardrails/handle-streaming-refusals).
  6. **Consider enabling extended thinking for complex tasks** Enable [extended thinking](https://docs.claude.com/en/docs/build-with-claude/extended-thinking) for significant performance improvements on coding and reasoning tasks (disabled by default):
Copy
```
response = client.messages.create(
    model="claude-haiku-4-5-20251001",
...
Extended thinking impacts [prompt caching](https://docs.claude.com/en/docs/build-with-claude/prompt-caching#caching-with-thinking-blocks) efficiency.
  7. **Explore new capabilities** See [What’s new in Claude 4.5](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#key-improvements-in-haiku-4-5-over-haiku-3-5) for details on context awareness, increased output capacity (64K tokens), higher intelligence, and improved speed.
...
### 
[​](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#haiku-3-5-%E2%86%92-4-5-migration-checklist)
...
## 
[​](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#choosing-between-sonnet-4-5-and-haiku-4-5)
...
### 
[​](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#choose-claude-sonnet-4-5-most-intelligent-for%3A)
...
### 
[​](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#choose-claude-haiku-4-5-fastest-and-most-intelligent-haiku-for%3A)
...
### 
[​](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#migrating-from-claude-sonnet-4-%E2%86%92-sonnet-4-5)
...
### 
[​](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#migrating-from-claude-opus-4-1-%E2%86%92-sonnet-4-5)
...
## 
[​](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#need-help%3F)
Need help?
  * Check our [API documentation](https://docs.claude.com/en/api/overview) for detailed specifications
  * Review [model capabilities](https://docs.claude.com/en/docs/about-claude/models/overview) for performance comparisons
  * Review [API release notes](https://docs.claude.com/en/release-notes/api) for API updates
  * Contact support if you encounter any issues during migration


Was this page helpful?
YesNo
[What's new in Claude 4.5](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5)[Model deprecations](https://docs.claude.com/en/docs/about-claude/model-deprecations)
Assistant
