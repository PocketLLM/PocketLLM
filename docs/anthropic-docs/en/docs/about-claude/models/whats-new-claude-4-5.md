# What's new in Claude 4.5 - Claude Docs> Source: https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5Agent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
On this page
  * [Key improvements in Sonnet 4.5 over Sonnet 4](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#key-improvements-in-sonnet-4-5-over-sonnet-4)
  * [Coding excellence](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#coding-excellence)
  * [Agent capabilities](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#agent-capabilities)
  * [Communication and interaction style](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#communication-and-interaction-style)
  * [Creative content generation](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#creative-content-generation)
  * [Key improvements in Haiku 4.5 over Haiku 3.5](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#key-improvements-in-haiku-4-5-over-haiku-3-5)
  * [Near-frontier intelligence with blazing speed](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#near-frontier-intelligence-with-blazing-speed)
  * [Extended thinking capabilities](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#extended-thinking-capabilities)
  * [Context awareness](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#context-awareness)
  * [Strong coding and tool use](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#strong-coding-and-tool-use)
  * [New API features](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#new-api-features)
  * [Memory tool (Beta)](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#memory-tool-beta)
  * [Context editing](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#context-editing)
  * [Enhanced stop reasons](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#enhanced-stop-reasons)
  * [Improved tool parameter handling](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#improved-tool-parameter-handling)
  * [Token count optimizations](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#token-count-optimizations)
  * [Features introduced in Claude 4](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#features-introduced-in-claude-4)
  * [New refusal stop reason](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#new-refusal-stop-reason)
  * [Summarized thinking](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#summarized-thinking)
  * [Interleaved thinking](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#interleaved-thinking)
  * [Behavioral differences](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#behavioral-differences)
  * [Communication style changes](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#communication-style-changes)
  * [Instruction following](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#instruction-following)
  * [Updated text editor tool](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#updated-text-editor-tool)
  * [Updated code execution tool](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#updated-code-execution-tool)
  * [Pricing and availability](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#pricing-and-availability)
  * [Pricing](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#pricing)
  * [Third-party platform pricing](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#third-party-platform-pricing)
  * [Availability](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#availability)
  * [Migration guide](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#migration-guide)
  * [Next steps](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#next-steps)
...
## 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#key-improvements-in-sonnet-4-5-over-sonnet-4)
Key improvements in Sonnet 4.5 over Sonnet 4
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#coding-excellence)
Coding excellence
...
Claude Sonnet 4.5 performs significantly better on coding tasks when [extended thinking](https://docs.claude.com/en/docs/build-with-claude/extended-thinking) is enabled. Extended thinking is disabled by default, but we recommend enabling it for complex coding work. Be aware that extended thinking impacts [prompt caching efficiency](https://docs.claude.com/en/docs/build-with-claude/prompt-caching#caching-with-thinking-blocks). See the [migration guide](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#extended-thinking-recommendations) for configuration details.
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#agent-capabilities)
Agent capabilities
...
## 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#key-improvements-in-haiku-4-5-over-haiku-3-5)
...
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#near-frontier-intelligence-with-blazing-speed)
...
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#extended-thinking-capabilities)
...
Extended thinking must be enabled explicitly by adding a `thinking` parameter to your API requests. See the [Extended thinking documentation](https://docs.claude.com/en/docs/build-with-claude/extended-thinking) for implementation details.
Claude Haiku 4.5 performs significantly better on coding and reasoning tasks when [extended thinking](https://docs.claude.com/en/docs/build-with-claude/extended-thinking) is enabled. Extended thinking is disabled by default, but we recommend enabling it for complex problem-solving, coding work, and multi-step reasoning. Be aware that extended thinking impacts [prompt caching efficiency](https://docs.claude.com/en/docs/build-with-claude/prompt-caching#caching-with-thinking-blocks). See the [migration guide](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4#extended-thinking-recommendations) for configuration details.
...
This is the first Haiku model with native context awareness capabilities. For prompting guidance, see [Claude 4 best practices](https://docs.claude.com/en/docs/build-with-claude/prompt-engineering/claude-4-best-practices#context-awareness-and-multi-window-workflows).
Available in Claude Sonnet 4, Sonnet 4.5, Haiku 4.5, Opus 4, and Opus 4.1.
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#strong-coding-and-tool-use)
...
## 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#new-api-features)
New API features
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#memory-tool-beta)
Memory tool (Beta)
The new [memory tool](https://docs.claude.com/en/docs/agents-and-tools/tool-use/memory-tool) enables Claude to store and retrieve information outside the context window:
Copy
```
tools=[
    {
...
Available in Claude Sonnet 4, Sonnet 4.5, Haiku 4.5, Opus 4, and Opus 4.1. Requires [beta header](https://docs.claude.com/en/api/beta-headers): `context-management-2025-06-27`
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#context-editing)
Context editing
Use [context editing](https://docs.claude.com/en/docs/build-with-claude/context-editing) for intelligent context management through automatic tool call clearing:
Copy
```
...
Available in Claude Sonnet 4, Sonnet 4.5, Haiku 4.5, Opus 4, and Opus 4.1. Requires [beta header](https://docs.claude.com/en/api/beta-headers): `context-management-2025-06-27`
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#enhanced-stop-reasons)
...
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#improved-tool-parameter-handling)
...
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#token-count-optimizations)
...
## 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#features-introduced-in-claude-4)
...
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#new-refusal-stop-reason)
...
When using Claude 4 models, you should update your application to [handle `refusal` stop reasons](https://docs.claude.com/en/docs/test-and-evaluate/strengthen-guardrails/handle-streaming-refusals).
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#summarized-thinking)
Summarized thinking
...
For more information, see the [Extended thinking documentation](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#summarized-thinking).
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#interleaved-thinking)
...
Interleaved thinking is in beta. To enable interleaved thinking, add [the beta header](https://docs.claude.com/en/api/beta-headers) `interleaved-thinking-2025-05-14` to your API request.
For more information, see the [Extended thinking documentation](https://docs.claude.com/en/docs/build-with-claude/extended-thinking#interleaved-thinking).
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#behavioral-differences)
Behavioral differences
Claude 4 models have notable behavioral changes that may affect how you structure prompts:
#### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#communication-style-changes)
...
#### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#instruction-following)
...
For comprehensive guidance on working with these models, see [Claude 4 prompt engineering best practices](https://docs.claude.com/en/docs/build-with-claude/prompt-engineering/claude-4-best-practices).
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#updated-text-editor-tool)
...
For more information, see the [Text editor tool documentation](https://docs.claude.com/en/docs/agents-and-tools/tool-use/text-editor-tool).
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#updated-code-execution-tool)
...
## 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#pricing-and-availability)
Pricing and availability
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#pricing)
Pricing
...
For more details, see the [pricing documentation](https://docs.claude.com/en/docs/about-claude/pricing).
### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#third-party-platform-pricing)
...
**This regional pricing applies to both Claude Sonnet 4.5 and Claude Haiku 4.5.** **The Claude API (1P) is global by default and unaffected by this change.** The Claude API is global-only (equivalent to the global endpoint offering and pricing from other providers). For implementation details and migration guidance:
  * [AWS Bedrock global vs regional endpoints](https://docs.claude.com/en/docs/build-with-claude/claude-on-amazon-bedrock#global-vs-regional-endpoints)
  * [Google Vertex AI global vs regional endpoints](https://docs.claude.com/en/docs/build-with-claude/claude-on-vertex-ai#global-vs-regional-endpoints)


### 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#availability)
Availability
...
## 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#migration-guide)
Migration guide
Breaking changes and migration requirements vary depending on which model you’re upgrading from. For detailed migration instructions, including step-by-step guides, breaking changes, and migration checklists, see [Migrating to Claude 4.5](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4). The migration guide covers the following scenarios:
...
## 
[​](https://docs.claude.com/en/docs/about-claude/models/whats-new-claude-4-5#next-steps)
Next steps
## [Best practices Learn prompt engineering techniques for Claude 4.5 models ](https://docs.claude.com/en/docs/build-with-claude/prompt-engineering/claude-4-best-practices)## [Model overview Compare Claude 4.5 models with other Claude models ](https://docs.claude.com/en/docs/about-claude/models/overview)## [Migration guide Upgrade from previous models ](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4)
Was this page helpful?
YesNo
[Choosing a model](https://docs.claude.com/en/docs/about-claude/models/choosing-a-model)[Migrating to Claude 4.5](https://docs.claude.com/en/docs/about-claude/models/migrating-to-claude-4)
Assistant
