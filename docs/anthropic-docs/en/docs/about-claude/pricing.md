# Pricing - Claude Docs> Source: https://docs.claude.com/en/docs/about-claude/pricingAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
On this page
  * [Model pricing](https://docs.claude.com/en/docs/about-claude/pricing#model-pricing)
  * [Third-party platform pricing](https://docs.claude.com/en/docs/about-claude/pricing#third-party-platform-pricing)
  * [Feature-specific pricing](https://docs.claude.com/en/docs/about-claude/pricing#feature-specific-pricing)
  * [Batch processing](https://docs.claude.com/en/docs/about-claude/pricing#batch-processing)
  * [Long context pricing](https://docs.claude.com/en/docs/about-claude/pricing#long-context-pricing)
  * [Tool use pricing](https://docs.claude.com/en/docs/about-claude/pricing#tool-use-pricing)
  * [Specific tool pricing](https://docs.claude.com/en/docs/about-claude/pricing#specific-tool-pricing)
  * [Bash tool](https://docs.claude.com/en/docs/about-claude/pricing#bash-tool)
  * [Code execution tool](https://docs.claude.com/en/docs/about-claude/pricing#code-execution-tool)
  * [Text editor tool](https://docs.claude.com/en/docs/about-claude/pricing#text-editor-tool)
  * [Web search tool](https://docs.claude.com/en/docs/about-claude/pricing#web-search-tool)
  * [Web fetch tool](https://docs.claude.com/en/docs/about-claude/pricing#web-fetch-tool)
  * [Computer use tool](https://docs.claude.com/en/docs/about-claude/pricing#computer-use-tool)
  * [Agent use case pricing examples](https://docs.claude.com/en/docs/about-claude/pricing#agent-use-case-pricing-examples)
  * [Customer support agent example](https://docs.claude.com/en/docs/about-claude/pricing#customer-support-agent-example)
  * [General agent workflow pricing](https://docs.claude.com/en/docs/about-claude/pricing#general-agent-workflow-pricing)
  * [Cost optimization strategies](https://docs.claude.com/en/docs/about-claude/pricing#cost-optimization-strategies)
  * [Additional pricing considerations](https://docs.claude.com/en/docs/about-claude/pricing#additional-pricing-considerations)
  * [Rate limits](https://docs.claude.com/en/docs/about-claude/pricing#rate-limits)
  * [Volume discounts](https://docs.claude.com/en/docs/about-claude/pricing#volume-discounts)
  * [Enterprise pricing](https://docs.claude.com/en/docs/about-claude/pricing#enterprise-pricing)
  * [Billing and payment](https://docs.claude.com/en/docs/about-claude/pricing#billing-and-payment)
  * [Frequently asked questions](https://docs.claude.com/en/docs/about-claude/pricing#frequently-asked-questions)
...
## 
[​](https://docs.claude.com/en/docs/about-claude/pricing#third-party-platform-pricing)
Third-party platform pricing
Claude models are available on [AWS Bedrock](https://docs.claude.com/en/docs/build-with-claude/claude-on-amazon-bedrock) and [Google Vertex AI](https://docs.claude.com/en/docs/build-with-claude/claude-on-vertex-ai). For official pricing, visit:
...
## 
[​](https://docs.claude.com/en/docs/about-claude/pricing#feature-specific-pricing)
Feature-specific pricing
### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#batch-processing)
Batch processing
...
For more information about batch processing, see our [batch processing documentation](https://docs.claude.com/en/docs/build-with-claude/batch-processing).
### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#long-context-pricing)
Long context pricing
When using Claude Sonnet 4 or Sonnet 4.5 with the [1M token context window enabled](https://docs.claude.com/en/docs/build-with-claude/context-windows#1m-token-context-window), requests that exceed 200K input tokens are automatically charged at premium long context rates:
The 1M token context window is currently in beta for organizations in [usage tier](https://docs.claude.com/en/api/rate-limits) 4 and organizations with custom rate limits. The 1M token context window is only available for Claude Sonnet 4 and Sonnet 4.5.
...
Long context pricing stacks with other pricing modifiers:
  * The [Batch API 50% discount](https://docs.claude.com/en/docs/about-claude/pricing#batch-processing) applies to long context pricing
  * [Prompt caching multipliers](https://docs.claude.com/en/docs/about-claude/pricing#model-pricing) apply on top of long context pricing
...
If the total exceeds 200,000 tokens, the entire request was billed at 1M context rates. For more information about the `usage` object, see the [API response documentation](https://docs.claude.com/en/api/messages#response-usage).
### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#tool-use-pricing)
Tool use pricing
...
* * *
313 tokens  
Claude Sonnet 3.7 ([deprecated](https://docs.claude.com/en/docs/about-claude/model-deprecations)) |  `auto`, `none`
* * *
`any`, `tool` | 346 tokens
* * *
313 tokens  
...
* * *
340 tokens  
Claude Opus 3 ([deprecated](https://docs.claude.com/en/docs/about-claude/model-deprecations)) |  `auto`, `none`
* * *
`any`, `tool` | 530 tokens
* * *
281 tokens  
...
* * *
340 tokens  
These token counts are added to your normal input and output tokens to calculate the total cost of a request. For current per-model prices, refer to our [model pricing](https://docs.claude.com/en/docs/about-claude/pricing#model-pricing) section above. For more information about tool use implementation and best practices, see our [tool use documentation](https://docs.claude.com/en/docs/agents-and-tools/tool-use/overview).
### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#specific-tool-pricing)
Specific tool pricing
#### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#bash-tool)
Bash tool
...
See [tool use pricing](https://docs.claude.com/en/docs/about-claude/pricing#tool-use-pricing) for complete pricing details.
#### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#code-execution-tool)
Code execution tool
...
#### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#text-editor-tool)
Text editor tool
...
See [tool use pricing](https://docs.claude.com/en/docs/about-claude/pricing#tool-use-pricing) for complete pricing details.
#### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#web-search-tool)
Web search tool
...
#### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#web-fetch-tool)
Web fetch tool
...
#### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#computer-use-tool)
Computer use tool
Computer use follows the standard [tool use pricing](https://docs.claude.com/en/docs/agents-and-tools/tool-use/overview#pricing). When using the computer use tool: **System prompt overhead** : The computer use beta adds 466-499 tokens to the system prompt **Computer use tool token usage** : Model | Input tokens per tool definition  
---|---  
Claude 4.x models | 735 tokens  
Claude Sonnet 3.7 ([deprecated](https://docs.claude.com/en/docs/about-claude/model-deprecations)) | 735 tokens  
**Additional token consumption** :
  * Screenshot images (see [Vision pricing](https://docs.claude.com/en/docs/build-with-claude/vision))
  * Tool execution results returned to Claude


If you’re also using bash or text editor tools alongside computer use, those tools have their own token costs as documented in their respective pages.
## 
[​](https://docs.claude.com/en/docs/about-claude/pricing#agent-use-case-pricing-examples)
...
### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#customer-support-agent-example)
...
For a detailed walkthrough of this calculation, see our [customer support agent guide](https://docs.claude.com/en/docs/about-claude/use-case-guides/customer-support-chat).
### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#general-agent-workflow-pricing)
...
### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#cost-optimization-strategies)
...
## 
[​](https://docs.claude.com/en/docs/about-claude/pricing#additional-pricing-considerations)
Additional pricing considerations
### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#rate-limits)
Rate limits
...
For detailed rate limit information, see our [rate limits documentation](https://docs.claude.com/en/api/rate-limits). For higher rate limits or custom pricing arrangements, [contact our sales team](https://claude.com/contact-sales).
### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#volume-discounts)
Volume discounts
...
### 
[​](https://docs.claude.com/en/docs/about-claude/pricing#enterprise-pricing)
Enterprise pricing
...
Contact our sales team at sales@anthropic.com or through the [Claude Console](https://console.anthropic.com/settings/limits) to discuss enterprise pricing options.
## 
[​](https://docs.claude.com/en/docs/about-claude/pricing#billing-and-payment)
Billing and payment
...
## 
[​](https://docs.claude.com/en/docs/about-claude/pricing#frequently-asked-questions)
...
YesNo
[Model deprecations](https://docs.claude.com/en/docs/about-claude/model-deprecations)[Features overview](https://docs.claude.com/en/docs/build-with-claude/overview)
Assistant
