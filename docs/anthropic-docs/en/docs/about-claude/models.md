# Models overview - Claude Docs> Source: https://docs.claude.com/en/docs/about-claude/modelsAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
On this page
  * [Choosing a model](https://docs.claude.com/en/docs/about-claude/models/overview#choosing-a-model)
  * [Latest models comparison](https://docs.claude.com/en/docs/about-claude/models/overview#latest-models-comparison)
  * [Prompt and output performance](https://docs.claude.com/en/docs/about-claude/models/overview#prompt-and-output-performance)
  * [Migrating to Claude 4.5](https://docs.claude.com/en/docs/about-claude/models/overview#migrating-to-claude-4-5)
  * [Get started with Claude](https://docs.claude.com/en/docs/about-claude/models/overview#get-started-with-claude)
...
Copy page
## 
[​](https://docs.claude.com/en/docs/about-claude/models/overview#choosing-a-model)
Choosing a model
If you’re unsure which model to use, we recommend starting with **Claude Sonnet 4.5**. It offers the best balance of intelligence, speed, and cost for most use cases, with exceptional performance in coding and agentic tasks. All current Claude models support text and image input, text output, multilingual capabilities, and vision. Models are available via the Anthropic API, AWS Bedrock, and Google Vertex AI. Once you’ve picked a model, [learn how to make your first API call](https://docs.claude.com/en/docs/get-started).
### 
...
## 
[​](https://docs.claude.com/en/docs/about-claude/models/overview#migrating-to-claude-4-5)
...
## 
[​](https://docs.claude.com/en/docs/about-claude/models/overview#get-started-with-claude)
Get started with Claude
If you’re ready to start exploring what Claude can do for you, let’s dive in! Whether you’re a developer looking to integrate Claude into your applications or a user wanting to experience the power of AI firsthand, we’ve got you covered.
Looking to chat with Claude? Visit [claude.ai](http://www.claude.ai)!
## [Intro to Claude Explore Claude’s capabilities and development flow. ](https://docs.claude.com/en/docs/intro)## [Quickstart Learn how to make your first API call in minutes. ](https://docs.claude.com/en/docs/get-started)## [Claude Console Craft and test powerful prompts directly in your browser. ](https://console.anthropic.com)
...
YesNo
[Quickstart](https://docs.claude.com/en/docs/get-started)[Choosing a model](https://docs.claude.com/en/docs/about-claude/models/choosing-a-model)
Assistant
