# Agent Skills - Claude Docs> Source: https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overviewAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
