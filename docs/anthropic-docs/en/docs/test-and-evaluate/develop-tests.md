# Create strong empirical evaluations - Claude Docs> Source: https://docs.claude.com/en/docs/test-and-evaluate/develop-testsAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
On this page
  * [Building evals and test cases](https://docs.claude.com/en/docs/test-and-evaluate/develop-tests#building-evals-and-test-cases)
  * [Eval design principles](https://docs.claude.com/en/docs/test-and-evaluate/develop-tests#eval-design-principles)
  * [Example evals](https://docs.claude.com/en/docs/test-and-evaluate/develop-tests#example-evals)
  * [Grading evals](https://docs.claude.com/en/docs/test-and-evaluate/develop-tests#grading-evals)
  * [Tips for LLM-based grading](https://docs.claude.com/en/docs/test-and-evaluate/develop-tests#tips-for-llm-based-grading)
  * [Next steps](https://docs.claude.com/en/docs/test-and-evaluate/develop-tests#next-steps)
...
## 
[​](https://docs.claude.com/en/docs/test-and-evaluate/develop-tests#building-evals-and-test-cases)
Building evals and test cases
### 
[​](https://docs.claude.com/en/docs/test-and-evaluate/develop-tests#eval-design-principles)
...
### 
[​](https://docs.claude.com/en/docs/test-and-evaluate/develop-tests#example-evals)
Example evals
...
* * *
## 
[​](https://docs.claude.com/en/docs/test-and-evaluate/develop-tests#grading-evals)
Grading evals
...
### 
[​](https://docs.claude.com/en/docs/test-and-evaluate/develop-tests#tips-for-llm-based-grading)
...
## 
[​](https://docs.claude.com/en/docs/test-and-evaluate/develop-tests#next-steps)
Next steps
## [Brainstorm evaluations Learn how to craft prompts that maximize your eval scores. ](https://docs.claude.com/en/docs/build-with-claude/prompt-engineering/overview)## [Evals cookbook More code examples of human-, code-, and LLM-graded evals. ](https://github.com/anthropics/anthropic-cookbook/blob/main/misc/building%5Fevals.ipynb)
Was this page helpful?
YesNo
[Define success criteria](https://docs.claude.com/en/docs/test-and-evaluate/define-success)[Using the Evaluation Tool](https://docs.claude.com/en/docs/test-and-evaluate/eval-tool)
Assistant
