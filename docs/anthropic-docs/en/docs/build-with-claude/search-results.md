# Search results - Claude Docs> Source: https://docs.claude.com/en/docs/build-with-claude/search-resultsAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
On this page
  * [Key benefits](https://docs.claude.com/en/docs/build-with-claude/search-results#key-benefits)
  * [How it works](https://docs.claude.com/en/docs/build-with-claude/search-results#how-it-works)
  * [Search result schema](https://docs.claude.com/en/docs/build-with-claude/search-results#search-result-schema)
  * [Required fields](https://docs.claude.com/en/docs/build-with-claude/search-results#required-fields)
  * [Optional fields](https://docs.claude.com/en/docs/build-with-claude/search-results#optional-fields)
  * [Method 1: Search results from tool calls](https://docs.claude.com/en/docs/build-with-claude/search-results#method-1%3A-search-results-from-tool-calls)
  * [Example: Knowledge base tool](https://docs.claude.com/en/docs/build-with-claude/search-results#example%3A-knowledge-base-tool)
  * [Method 2: Search results as top-level content](https://docs.claude.com/en/docs/build-with-claude/search-results#method-2%3A-search-results-as-top-level-content)
  * [Example: Direct search results](https://docs.claude.com/en/docs/build-with-claude/search-results#example%3A-direct-search-results)
  * [Claude’s response with citations](https://docs.claude.com/en/docs/build-with-claude/search-results#claude%E2%80%99s-response-with-citations)
  * [Citation fields](https://docs.claude.com/en/docs/build-with-claude/search-results#citation-fields)
  * [Multiple content blocks](https://docs.claude.com/en/docs/build-with-claude/search-results#multiple-content-blocks)
  * [Advanced usage](https://docs.claude.com/en/docs/build-with-claude/search-results#advanced-usage)
  * [Combining both methods](https://docs.claude.com/en/docs/build-with-claude/search-results#combining-both-methods)
  * [Combining with other content types](https://docs.claude.com/en/docs/build-with-claude/search-results#combining-with-other-content-types)
  * [Cache control](https://docs.claude.com/en/docs/build-with-claude/search-results#cache-control)
  * [Citation control](https://docs.claude.com/en/docs/build-with-claude/search-results#citation-control)
  * [Best practices](https://docs.claude.com/en/docs/build-with-claude/search-results#best-practices)
  * [For tool-based search (Method 1)](https://docs.claude.com/en/docs/build-with-claude/search-results#for-tool-based-search-method-1)
  * [For top-level search (Method 2)](https://docs.claude.com/en/docs/build-with-claude/search-results#for-top-level-search-method-2)
  * [General best practices](https://docs.claude.com/en/docs/build-with-claude/search-results#general-best-practices)
  * [Limitations](https://docs.claude.com/en/docs/build-with-claude/search-results#limitations)
...
## 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#key-benefits)
Key benefits
...
## 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#how-it-works)
How it works
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#search-result-schema)
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#required-fields)
Required fields
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#optional-fields)
Optional fields
Field | Type | Description  
---|---|---  
...
## 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#method-1%3A-search-results-from-tool-calls)
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#example%3A-knowledge-base-tool)
...
## 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#method-2%3A-search-results-as-top-level-content)
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#example%3A-direct-search-results)
...
## 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#claude%E2%80%99s-response-with-citations)
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#citation-fields)
Citation fields
...
## 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#multiple-content-blocks)
...
## 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#advanced-usage)
Advanced usage
### 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#combining-both-methods)
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#combining-with-other-content-types)
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#cache-control)
Cache control
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#citation-control)
Citation control
...
## 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#best-practices)
Best practices
### 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#for-tool-based-search-method-1)
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#for-top-level-search-method-2)
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#general-best-practices)
...
## 
[​](https://docs.claude.com/en/docs/build-with-claude/search-results#limitations)
Limitations
...
YesNo
[Files API](https://docs.claude.com/en/docs/build-with-claude/files)[Google Sheets add-on](https://docs.claude.com/en/docs/agents-and-tools/claude-for-sheets)
Assistant
