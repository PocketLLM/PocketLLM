# Using Agent Skills with the API - Claude Docs> Source: https://docs.claude.com/en/docs/build-with-claude/skills-guideAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
On this page
  * [Quick Links](https://docs.claude.com/en/docs/build-with-claude/skills-guide#quick-links)
  * [Overview](https://docs.claude.com/en/docs/build-with-claude/skills-guide#overview)
  * [Using Skills](https://docs.claude.com/en/docs/build-with-claude/skills-guide#using-skills)
  * [Prerequisites](https://docs.claude.com/en/docs/build-with-claude/skills-guide#prerequisites)
  * [Using Skills in Messages](https://docs.claude.com/en/docs/build-with-claude/skills-guide#using-skills-in-messages)
  * [Container Parameter](https://docs.claude.com/en/docs/build-with-claude/skills-guide#container-parameter)
  * [Downloading Generated Files](https://docs.claude.com/en/docs/build-with-claude/skills-guide#downloading-generated-files)
  * [Multi-Turn Conversations](https://docs.claude.com/en/docs/build-with-claude/skills-guide#multi-turn-conversations)
  * [Long-Running Operations](https://docs.claude.com/en/docs/build-with-claude/skills-guide#long-running-operations)
  * [Using Multiple Skills](https://docs.claude.com/en/docs/build-with-claude/skills-guide#using-multiple-skills)
  * [Managing Custom Skills](https://docs.claude.com/en/docs/build-with-claude/skills-guide#managing-custom-skills)
  * [Creating a Skill](https://docs.claude.com/en/docs/build-with-claude/skills-guide#creating-a-skill)
  * [Listing Skills](https://docs.claude.com/en/docs/build-with-claude/skills-guide#listing-skills)
  * [Retrieving a Skill](https://docs.claude.com/en/docs/build-with-claude/skills-guide#retrieving-a-skill)
  * [Deleting a Skill](https://docs.claude.com/en/docs/build-with-claude/skills-guide#deleting-a-skill)
  * [Versioning](https://docs.claude.com/en/docs/build-with-claude/skills-guide#versioning)
  * [How Skills Are Loaded](https://docs.claude.com/en/docs/build-with-claude/skills-guide#how-skills-are-loaded)
  * [Use Cases](https://docs.claude.com/en/docs/build-with-claude/skills-guide#use-cases)
  * [Organizational Skills](https://docs.claude.com/en/docs/build-with-claude/skills-guide#organizational-skills)
  * [Personal Skills](https://docs.claude.com/en/docs/build-with-claude/skills-guide#personal-skills)
  * [Example: Financial Modeling](https://docs.claude.com/en/docs/build-with-claude/skills-guide#example%3A-financial-modeling)
  * [Limits and Constraints](https://docs.claude.com/en/docs/build-with-claude/skills-guide#limits-and-constraints)
  * [Request Limits](https://docs.claude.com/en/docs/build-with-claude/skills-guide#request-limits)
  * [Environment Constraints](https://docs.claude.com/en/docs/build-with-claude/skills-guide#environment-constraints)
  * [Best Practices](https://docs.claude.com/en/docs/build-with-claude/skills-guide#best-practices)
  * [When to Use Multiple Skills](https://docs.claude.com/en/docs/build-with-claude/skills-guide#when-to-use-multiple-skills)
  * [Version Management Strategy](https://docs.claude.com/en/docs/build-with-claude/skills-guide#version-management-strategy)
  * [Prompt Caching Considerations](https://docs.claude.com/en/docs/build-with-claude/skills-guide#prompt-caching-considerations)
  * [Error Handling](https://docs.claude.com/en/docs/build-with-claude/skills-guide#error-handling)
  * [Next Steps](https://docs.claude.com/en/docs/build-with-claude/skills-guide#next-steps)
...
For complete API reference including request/response schemas and all parameters, see:
  * [Skill Management API Reference](https://docs.claude.com/en/api/skills/list-skills) - CRUD operations for Skills
  * [Skill Versions API Reference](https://docs.claude.com/en/api/skills/list-skill-versions) - Version management


## 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#quick-links)
Quick Links
## [Get started with Agent Skills Create your first Skill ](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/quickstart)## [Create Custom Skills Best practices for authoring Skills ](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/best-practices)
## 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#overview)
Overview
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#using-skills)
Using Skills
...
**Management** | Pre-built and maintained by Anthropic | Upload and manage via [Skills API](https://docs.claude.com/en/api/skills/create-skill)  
**Availability** | Available to all users | Private to your workspace  
Both skill sources are returned by the [List Skills endpoint](https://docs.claude.com/en/api/skills/list-skills) (use the `source` parameter to filter). The integration shape and execution environment are identical—the only difference is where the Skills come from and how they’re managed.
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#prerequisites)
Prerequisites
...
* * *
## 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#using-skills-in-messages)
Using Skills in Messages
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#container-parameter)
Container Parameter
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#downloading-generated-files)
...
For complete details on the Files API, see the [Files API documentation](https://docs.claude.com/en/api/files-content).
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#multi-turn-conversations)
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#long-running-operations)
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#using-multiple-skills)
...
* * *
## 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#managing-custom-skills)
Managing Custom Skills
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#creating-a-skill)
Creating a Skill
...
For complete request/response schemas, see the [Create Skill API reference](https://docs.claude.com/en/api/skills/create-skill).
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#listing-skills)
Listing Skills
...
See the [List Skills API reference](https://docs.claude.com/en/api/skills/list-skills) for pagination and filtering options.
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#retrieving-a-skill)
Retrieving a Skill
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#deleting-a-skill)
Deleting a Skill
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#versioning)
Versioning
...
See the [Create Skill Version API reference](https://docs.claude.com/en/api/skills/create-skill-version) for complete details.
* * *
## 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#how-skills-are-loaded)
...
* * *
## 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#use-cases)
Use Cases
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#organizational-skills)
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#personal-skills)
Personal Skills
**Content Creation**
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#example%3A-financial-modeling)
...
* * *
## 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#limits-and-constraints)
Limits and Constraints
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#request-limits)
Request Limits
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#environment-constraints)
...
See the [code execution tool documentation](https://docs.claude.com/en/docs/agents-and-tools/tool-use/code-execution-tool) for available packages.
* * *
## 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#best-practices)
Best Practices
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#when-to-use-multiple-skills)
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#version-management-strategy)
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#prompt-caching-considerations)
...
### 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#error-handling)
Error Handling
...
* * *
## 
[​](https://docs.claude.com/en/docs/build-with-claude/skills-guide#next-steps)
Next Steps
## [API Reference Complete API reference with all endpoints ](https://docs.claude.com/en/api/skills/create-skill)## [Authoring Guide Best practices for writing effective Skills ](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/best-practices)## [Code Execution Tool Learn about the code execution environment ](https://docs.claude.com/en/docs/agents-and-tools/tool-use/code-execution-tool)
Was this page helpful?
YesNo
[Best practices](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/best-practices)[Overview](https://docs.claude.com/en/docs/agent-sdk/overview)
Assistant
