# Agent SDK overview - Claude Docs> Source: https://docs.claude.com/en/docs/agent-sdk/overviewAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
On this page
  * [Installation](https://docs.claude.com/en/docs/agent-sdk/overview#installation)
  * [SDK Options](https://docs.claude.com/en/docs/agent-sdk/overview#sdk-options)
  * [Why use the Claude Agent SDK?](https://docs.claude.com/en/docs/agent-sdk/overview#why-use-the-claude-agent-sdk%3F)
  * [What can you build with the SDK?](https://docs.claude.com/en/docs/agent-sdk/overview#what-can-you-build-with-the-sdk%3F)
  * [Core Concepts](https://docs.claude.com/en/docs/agent-sdk/overview#core-concepts)
  * [Authentication](https://docs.claude.com/en/docs/agent-sdk/overview#authentication)
  * [Full Claude Code Feature Support](https://docs.claude.com/en/docs/agent-sdk/overview#full-claude-code-feature-support)
  * [System Prompts](https://docs.claude.com/en/docs/agent-sdk/overview#system-prompts)
  * [Tool Permissions](https://docs.claude.com/en/docs/agent-sdk/overview#tool-permissions)
  * [Model Context Protocol (MCP)](https://docs.claude.com/en/docs/agent-sdk/overview#model-context-protocol-mcp)
  * [Building with the Claude Agent SDK](https://docs.claude.com/en/docs/agent-sdk/overview#building-with-the-claude-agent-sdk)
  * [For partners integrating Claude Agent SDK:](https://docs.claude.com/en/docs/agent-sdk/overview#for-partners-integrating-claude-agent-sdk%3A)
  * [Reporting Bugs](https://docs.claude.com/en/docs/agent-sdk/overview#reporting-bugs)
  * [Changelog](https://docs.claude.com/en/docs/agent-sdk/overview#changelog)
  * [Related Resources](https://docs.claude.com/en/docs/agent-sdk/overview#related-resources)
...
## 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#installation)
Installation
TypeScript
Python
Copy
...
## 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#sdk-options)
SDK Options
The Claude Agent SDK is available in multiple forms to suit different use cases:
  * **[TypeScript SDK](https://docs.claude.com/en/docs/agent-sdk/typescript)** - For Node.js and web applications
  * **[Python SDK](https://docs.claude.com/en/docs/agent-sdk/python)** - For Python applications and data science
  * **[Streaming vs Single Mode](https://docs.claude.com/en/docs/agent-sdk/streaming-vs-single-mode)** - Understanding input modes and best practices


## 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#why-use-the-claude-agent-sdk%3F)
...
## 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#what-can-you-build-with-the-sdk%3F)
...
## 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#core-concepts)
Core Concepts
### 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#authentication)
Authentication
...
### 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#full-claude-code-feature-support)
...
The SDK provides access to all the default features available in Claude Code, leveraging the same file system-based configuration:
  ...
  * **Plugins** : Load custom plugins programmatically using the `plugins` option to extend Claude Code with custom commands, agents, skills, hooks, and MCP servers. See [Plugins](https://docs.claude.com/en/docs/agent-sdk/plugins) for details.
...
### 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#system-prompts)
System Prompts
System prompts define your agent’s role, expertise, and behavior. This is where you specify what kind of agent you’re building.
### 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#tool-permissions)
Tool Permissions
...
### 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#model-context-protocol-mcp)
...
## 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#building-with-the-claude-agent-sdk)
...
### 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#for-partners-integrating-claude-agent-sdk%3A)
...
Your product should maintain its own branding and not appear to be Claude Code or any Anthropic product. For questions about branding compliance or to discuss your product’s Claude integration, [contact our sales team](https://claude.com/contact-sales).
## 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#reporting-bugs)
Reporting Bugs
...
## 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#changelog)
Changelog
...
## 
[​](https://docs.claude.com/en/docs/agent-sdk/overview#related-resources)
Related Resources
...
YesNo
[Using Skills with the API](https://docs.claude.com/en/docs/build-with-claude/skills-guide)[TypeScript SDK](https://docs.claude.com/en/docs/agent-sdk/typescript)
Assistant
