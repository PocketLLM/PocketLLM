# Beta headers - Claude Docs> Source: https://docs.claude.com/en/api/beta-headersAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
On this page
  * [How to use beta headers](https://docs.claude.com/en/api/beta-headers#how-to-use-beta-headers)
  * [Multiple beta features](https://docs.claude.com/en/api/beta-headers#multiple-beta-features)
  * [Version naming conventions](https://docs.claude.com/en/api/beta-headers#version-naming-conventions)
  * [Error handling](https://docs.claude.com/en/api/beta-headers#error-handling)
  * [Getting help](https://docs.claude.com/en/api/beta-headers#getting-help)
...
Beta headers are often used in conjunction with the [beta namespace in the client SDKs](https://docs.claude.com/en/api/client-sdks#beta-namespace-in-client-sdks)
## 
[​](https://docs.claude.com/en/api/beta-headers#how-to-use-beta-headers)
...
### 
[​](https://docs.claude.com/en/api/beta-headers#multiple-beta-features)
...
### 
[​](https://docs.claude.com/en/api/beta-headers#version-naming-conventions)
...
## 
[​](https://docs.claude.com/en/api/beta-headers#error-handling)
Error handling
...
## 
[​](https://docs.claude.com/en/api/beta-headers#getting-help)
Getting help
For questions about beta features:
  1. Check the documentation for the specific feature
  2. Review the [API changelog](https://docs.claude.com/en/api/versioning) for updates
...
YesNo
[Client SDKs](https://docs.claude.com/en/api/client-sdks)[Errors](https://docs.claude.com/en/api/errors)
Assistant
