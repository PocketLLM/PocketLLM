# Get Claude Code Usage Report - Claude Docs> Source: https://docs.claude.com/en/api/admin-api/claude-code/get-claude-code-usage-reportAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
#### Headers
[​](https://docs.claude.com/en/api/admin-api/claude-code/get-claude-code-usage-report#parameter-x-api-key)
x-api-key
string
required
Your unique Admin API key for authentication.
This key is required in the header of all Admin API requests, to authenticate your account and access Anthropic's services. Get your Admin API key through the [Console](https://console.anthropic.com/settings/admin-keys).
[​](https://docs.claude.com/en/api/admin-api/claude-code/get-claude-code-usage-report#parameter-anthropic-version)
anthropic-version
string
required
...
#### Query Parameters
[​](https://docs.claude.com/en/api/admin-api/claude-code/get-claude-code-usage-report#parameter-starting-at)
starting_at
string
required
UTC date in YYYY-MM-DD format. Returns metrics for this single day only.
[​](https://docs.claude.com/en/api/admin-api/claude-code/get-claude-code-usage-report#parameter-limit)
limit
integer
default:20
Number of records per page (default: 20, max: 1000).
Required range: `1 <= x <= 1000`
[​](https://docs.claude.com/en/api/admin-api/claude-code/get-claude-code-usage-report#parameter-page)
page
string | null
...
application/json
Successful Response
[​](https://docs.claude.com/en/api/admin-api/claude-code/get-claude-code-usage-report#response-data)
data
ClaudeCodeUsageReportItem · object[]
required
List of Claude Code usage records for the requested date.
Show child attributes
[​](https://docs.claude.com/en/api/admin-api/claude-code/get-claude-code-usage-report#response-has-more)
has_more
boolean
required
True if there are more records available beyond the current page.
[​](https://docs.claude.com/en/api/admin-api/claude-code/get-claude-code-usage-report#response-next-page)
next_page
string | null
required
...
YesNo
[Get Cost Report](https://docs.claude.com/en/api/admin-api/usage-cost/get-cost-report)[Generate a prompt](https://docs.claude.com/en/api/prompt-tools-generate)
Assistant
