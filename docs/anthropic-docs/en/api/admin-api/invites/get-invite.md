# Get Invite - Claude Docs> Source: https://docs.claude.com/en/api/admin-api/invites/get-inviteAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
##### Admin API
  ...
  * Organization Invites
    * [GETGet Invite](https://docs.claude.com/en/api/admin-api/invites/get-invite)
    * [GETList Invites](https://docs.claude.com/en/api/admin-api/invites/list-invites)
    * [POSTCreate Invite](https://docs.claude.com/en/api/admin-api/invites/create-invite)
    * [DELDelete Invite](https://docs.claude.com/en/api/admin-api/invites/delete-invite)
...
#### Headers
[​](https://docs.claude.com/en/api/admin-api/invites/get-invite#parameter-x-api-key)
x-api-key
string
required
Your unique Admin API key for authentication.
This key is required in the header of all Admin API requests, to authenticate your account and access Anthropic's services. Get your Admin API key through the [Console](https://console.anthropic.com/settings/admin-keys).
[​](https://docs.claude.com/en/api/admin-api/invites/get-invite#parameter-anthropic-version)
anthropic-version
string
required
...
#### Path Parameters
[​](https://docs.claude.com/en/api/admin-api/invites/get-invite#parameter-invite-id)
invite_id
string
required
ID of the Invite.
...
application/json
Successful Response
[​](https://docs.claude.com/en/api/admin-api/invites/get-invite#response-email)
email
string
required
...
[​](https://docs.claude.com/en/api/admin-api/invites/get-invite#response-expires-at)
expires_at
string<date-time>
required
...
[​](https://docs.claude.com/en/api/admin-api/invites/get-invite#response-id)
id
string
required
ID of the Invite.
...
[​](https://docs.claude.com/en/api/admin-api/invites/get-invite#response-invited-at)
invited_at
string<date-time>
required
...
[​](https://docs.claude.com/en/api/admin-api/invites/get-invite#response-role)
role
enum<string>
required
...
`admin`,
`claude_code_user`
[​](https://docs.claude.com/en/api/admin-api/invites/get-invite#response-status)
status
enum<string>
required
...
`deleted`,
`pending`
[​](https://docs.claude.com/en/api/admin-api/invites/get-invite#response-type)
type
enum<string>
default:invite
required
...
YesNo
[Remove User](https://docs.claude.com/en/api/admin-api/users/remove-user)[List Invites](https://docs.claude.com/en/api/admin-api/invites/list-invites)
Assistant
