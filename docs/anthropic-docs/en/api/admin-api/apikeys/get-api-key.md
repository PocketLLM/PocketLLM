# Get API Key - Claude Docs> Source: https://docs.claude.com/en/api/admin-api/apikeys/get-api-keyAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
#### Headers
[​](https://docs.claude.com/en/api/admin-api/apikeys/get-api-key#parameter-x-api-key)
x-api-key
string
required
Your unique Admin API key for authentication.
This key is required in the header of all Admin API requests, to authenticate your account and access Anthropic's services. Get your Admin API key through the [Console](https://console.anthropic.com/settings/admin-keys).
[​](https://docs.claude.com/en/api/admin-api/apikeys/get-api-key#parameter-anthropic-version)
anthropic-version
string
required
...
#### Path Parameters
[​](https://docs.claude.com/en/api/admin-api/apikeys/get-api-key#parameter-api-key-id)
api_key_id
string
required
ID of the API key.
...
application/json
Successful Response
[​](https://docs.claude.com/en/api/admin-api/apikeys/get-api-key#response-created-at)
created_at
string<date-time>
required
...
[​](https://docs.claude.com/en/api/admin-api/apikeys/get-api-key#response-created-by)
created_by
object
required
The ID and type of the actor that created the API key.
Show child attributes
[​](https://docs.claude.com/en/api/admin-api/apikeys/get-api-key#response-id)
id
string
required
ID of the API key.
...
[​](https://docs.claude.com/en/api/admin-api/apikeys/get-api-key#response-name)
name
string
required
Name of the API key.
Examples:
`"Developer Key"`
[​](https://docs.claude.com/en/api/admin-api/apikeys/get-api-key#response-partial-key-hint)
partial_key_hint
string | null
required
...
[​](https://docs.claude.com/en/api/admin-api/apikeys/get-api-key#response-status)
status
enum<string>
required
...
Examples:
`"active"`
[​](https://docs.claude.com/en/api/admin-api/apikeys/get-api-key#response-type)
type
enum<string>
default:api_key
required
...
---|---  
Type | `api_key`  
[​](https://docs.claude.com/en/api/admin-api/apikeys/get-api-key#response-workspace-id)
workspace_id
string | null
required
...
YesNo
[Delete Workspace Member](https://docs.claude.com/en/api/admin-api/workspace_members/delete-workspace-member)[List API Keys](https://docs.claude.com/en/api/admin-api/apikeys/list-api-keys)
Assistant
