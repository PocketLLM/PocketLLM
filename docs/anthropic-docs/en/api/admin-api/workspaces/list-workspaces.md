# List Workspaces - Claude Docs> Source: https://docs.claude.com/en/api/admin-api/workspaces/list-workspacesAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
##### Admin API
  ...
  * Workspace Management
    * [GETGet Workspace](https://docs.claude.com/en/api/admin-api/workspaces/get-workspace)
    * [GETList Workspaces](https://docs.claude.com/en/api/admin-api/workspaces/list-workspaces)
    * [POSTUpdate Workspace](https://docs.claude.com/en/api/admin-api/workspaces/update-workspace)
    * [POSTCreate Workspace](https://docs.claude.com/en/api/admin-api/workspaces/create-workspace)
    * [POSTArchive Workspace](https://docs.claude.com/en/api/admin-api/workspaces/archive-workspace)
...
#### Headers
[​](https://docs.claude.com/en/api/admin-api/workspaces/list-workspaces#parameter-x-api-key)
x-api-key
string
required
Your unique Admin API key for authentication.
This key is required in the header of all Admin API requests, to authenticate your account and access Anthropic's services. Get your Admin API key through the [Console](https://console.anthropic.com/settings/admin-keys).
[​](https://docs.claude.com/en/api/admin-api/workspaces/list-workspaces#parameter-anthropic-version)
anthropic-version
string
required
...
#### Query Parameters
[​](https://docs.claude.com/en/api/admin-api/workspaces/list-workspaces#parameter-include-archived)
include_archived
boolean
default:false
Whether to include Workspaces that have been archived in the response
[​](https://docs.claude.com/en/api/admin-api/workspaces/list-workspaces#parameter-before-id)
before_id
string
ID of the object to use as a cursor for pagination. When provided, returns the page of results immediately before this object.
[​](https://docs.claude.com/en/api/admin-api/workspaces/list-workspaces#parameter-after-id)
after_id
string
ID of the object to use as a cursor for pagination. When provided, returns the page of results immediately after this object.
[​](https://docs.claude.com/en/api/admin-api/workspaces/list-workspaces#parameter-limit)
limit
integer
default:20
...
application/json
Successful Response
[​](https://docs.claude.com/en/api/admin-api/workspaces/list-workspaces#response-data)
data
Workspace · object[]
required
Show child attributes
[​](https://docs.claude.com/en/api/admin-api/workspaces/list-workspaces#response-first-id)
first_id
string | null
required
First ID in the `data` list. Can be used as the `before_id` for the previous page.
[​](https://docs.claude.com/en/api/admin-api/workspaces/list-workspaces#response-has-more)
has_more
boolean
required
Indicates if there are more results in the requested page direction.
[​](https://docs.claude.com/en/api/admin-api/workspaces/list-workspaces#response-last-id)
last_id
string | null
required
...
YesNo
[Get Workspace](https://docs.claude.com/en/api/admin-api/workspaces/get-workspace)[Update Workspace](https://docs.claude.com/en/api/admin-api/workspaces/update-workspace)
Assistant
