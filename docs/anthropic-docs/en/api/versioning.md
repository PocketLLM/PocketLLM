# Versions - Claude Docs> Source: https://docs.claude.com/en/api/versioningAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
On this page
  * [Version history](https://docs.claude.com/en/api/versioning#version-history)


Support & configuration
# Versions
Copy page
When making API requests, you must send an `anthropic-version` request header. For example, `anthropic-version: 2023-06-01`. If you are using our [client SDKs](https://docs.claude.com/en/api/client-sdks), this is handled for you automatically.
Copy page
...
We always recommend using the latest API version whenever possible. Previous versions are considered deprecated and may be unavailable for new users.
  * `2023-06-01`
    * New format for [streaming](https://docs.claude.com/en/docs/build-with-claude/streaming) server-sent events (SSE): 
...
YesNo
[Service tiers](https://docs.claude.com/en/api/service-tiers)[IP addresses](https://docs.claude.com/en/api/ip-addresses)
Assistant
