# List Message Batches - Claude Docs> Source: https://docs.claude.com/en/api/listing-message-batchesAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
#### Headers
[​](https://docs.claude.com/en/api/listing-message-batches#parameter-anthropic-beta)
anthropic-beta
string[]
Optional header to specify the beta version(s) you want to use.
To use multiple betas, use a comma separated list like `beta1,beta2` or specify the header multiple times for each beta.
[​](https://docs.claude.com/en/api/listing-message-batches#parameter-anthropic-version)
anthropic-version
string
required
...
[​](https://docs.claude.com/en/api/listing-message-batches#parameter-x-api-key)
x-api-key
string
required
...
#### Query Parameters
[​](https://docs.claude.com/en/api/listing-message-batches#parameter-before-id)
before_id
string
ID of the object to use as a cursor for pagination. When provided, returns the page of results immediately before this object.
[​](https://docs.claude.com/en/api/listing-message-batches#parameter-after-id)
after_id
string
ID of the object to use as a cursor for pagination. When provided, returns the page of results immediately after this object.
[​](https://docs.claude.com/en/api/listing-message-batches#parameter-limit)
limit
integer
default:20
...
application/json
Successful Response
[​](https://docs.claude.com/en/api/listing-message-batches#response-data)
data
MessageBatch · object[]
required
Show child attributes
[​](https://docs.claude.com/en/api/listing-message-batches#response-first-id)
first_id
string | null
required
First ID in the `data` list. Can be used as the `before_id` for the previous page.
[​](https://docs.claude.com/en/api/listing-message-batches#response-has-more)
has_more
boolean
required
Indicates if there are more results in the requested page direction.
[​](https://docs.claude.com/en/api/listing-message-batches#response-last-id)
last_id
string | null
required
...
YesNo
[Retrieve Message Batch Results](https://docs.claude.com/en/api/retrieving-message-batch-results)[Cancel a Message Batch](https://docs.claude.com/en/api/canceling-message-batches)
Assistant
