# Create a File - Claude Docs> Source: https://docs.claude.com/en/api/files-createAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
#### Headers
[​](https://docs.claude.com/en/api/files-create#parameter-anthropic-beta)
anthropic-beta
string[]
Optional header to specify the beta version(s) you want to use.
To use multiple betas, use a comma separated list like `beta1,beta2` or specify the header multiple times for each beta.
[​](https://docs.claude.com/en/api/files-create#parameter-anthropic-version)
anthropic-version
string
required
...
[​](https://docs.claude.com/en/api/files-create#parameter-x-api-key)
x-api-key
string
required
...
#### Body
multipart/form-data
[​](https://docs.claude.com/en/api/files-create#body-file)
file
file
required
The file to upload
...
application/json
Successful Response
[​](https://docs.claude.com/en/api/files-create#response-created-at)
created_at
string<date-time>
required
RFC 3339 datetime string representing when the file was created.
[​](https://docs.claude.com/en/api/files-create#response-filename)
filename
string
required
Original filename of the uploaded file.
Required string length: `1 - 500`
[​](https://docs.claude.com/en/api/files-create#response-id)
id
string
required
Unique object identifier.
The format and length of IDs may change over time.
[​](https://docs.claude.com/en/api/files-create#response-mime-type)
mime_type
string
required
MIME type of the file.
Required string length: `1 - 255`
[​](https://docs.claude.com/en/api/files-create#response-size-bytes)
size_bytes
integer
required
Size of the file in bytes.
Required range: `x >= 0`
[​](https://docs.claude.com/en/api/files-create#response-type)
type
string
required
Object type.
...
Allowed value: `"file"`
[​](https://docs.claude.com/en/api/files-create#response-downloadable)
downloadable
boolean
default:false
...
YesNo
[Delete a Message Batch](https://docs.claude.com/en/api/deleting-message-batches)[List Files](https://docs.claude.com/en/api/files-list)
Assistant
