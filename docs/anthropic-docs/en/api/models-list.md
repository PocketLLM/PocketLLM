# List Models - Claude Docs> Source: https://docs.claude.com/en/api/models-listAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
#### Headers
[​](https://docs.claude.com/en/api/models-list#parameter-anthropic-version)
anthropic-version
string
required
...
[​](https://docs.claude.com/en/api/models-list#parameter-x-api-key)
x-api-key
string
required
Your unique API key for authentication.
This key is required in the header of all API requests, to authenticate your account and access Anthropic's services. Get your API key through the [Console](https://console.anthropic.com/settings/keys). Each key is scoped to a Workspace.
[​](https://docs.claude.com/en/api/models-list#parameter-anthropic-beta)
anthropic-beta
string[]
Optional header to specify the beta version(s) you want to use.
To use multiple betas, use a comma separated list like `beta1,beta2` or specify the header multiple times for each beta.
#### Query Parameters
[​](https://docs.claude.com/en/api/models-list#parameter-before-id)
before_id
string
ID of the object to use as a cursor for pagination. When provided, returns the page of results immediately before this object.
[​](https://docs.claude.com/en/api/models-list#parameter-after-id)
after_id
string
ID of the object to use as a cursor for pagination. When provided, returns the page of results immediately after this object.
[​](https://docs.claude.com/en/api/models-list#parameter-limit)
limit
integer
default:20
...
application/json
Successful Response
[​](https://docs.claude.com/en/api/models-list#response-data)
data
ModelInfo · object[]
required
Show child attributes
[​](https://docs.claude.com/en/api/models-list#response-first-id)
first_id
string | null
required
First ID in the `data` list. Can be used as the `before_id` for the previous page.
[​](https://docs.claude.com/en/api/models-list#response-has-more)
has_more
boolean
required
Indicates if there are more results in the requested page direction.
[​](https://docs.claude.com/en/api/models-list#response-last-id)
last_id
string | null
required
...
YesNo
[Count Message tokens](https://docs.claude.com/en/api/messages-count-tokens)[Get a Model](https://docs.claude.com/en/api/models)
Assistant
