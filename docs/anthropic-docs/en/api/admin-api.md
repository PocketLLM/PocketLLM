# Get Organization Info - Claude Docs> Source: https://docs.claude.com/en/api/admin-apiAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
##### Admin API
  * Organization Info
    * [GETGet Organization Info](https://docs.claude.com/en/api/admin-api/organization/get-me)
...
#### Headers
[​](https://docs.claude.com/en/api/admin-api/organization/get-me#parameter-x-api-key)
x-api-key
string
required
Your unique Admin API key for authentication.
This key is required in the header of all Admin API requests, to authenticate your account and access Anthropic's services. Get your Admin API key through the [Console](https://console.anthropic.com/settings/admin-keys).
[​](https://docs.claude.com/en/api/admin-api/organization/get-me#parameter-anthropic-version)
anthropic-version
string
required
...
application/json
Successful Response
[​](https://docs.claude.com/en/api/admin-api/organization/get-me#response-id)
id
string<uuid>
required
...
[​](https://docs.claude.com/en/api/admin-api/organization/get-me#response-name)
name
string
required
...
Examples:
`"Organization Name"`
[​](https://docs.claude.com/en/api/admin-api/organization/get-me#response-type)
type
enum<string>
...
YesNo
[Delete Skill Version](https://docs.claude.com/en/api/skills/delete-skill-version)[Get User](https://docs.claude.com/en/api/admin-api/users/get-user)
Assistant
