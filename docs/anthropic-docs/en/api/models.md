# Get a Model - Claude Docs> Source: https://docs.claude.com/en/api/modelsAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
