# Create Skill Version - Claude Docs> Source: https://docs.claude.com/en/api/skills/create-skill-versionAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
#### Headers
[​](https://docs.claude.com/en/api/skills/create-skill-version#parameter-anthropic-beta)
anthropic-beta
string[]
Optional header to specify the beta version(s) you want to use.
To use multiple betas, use a comma separated list like `beta1,beta2` or specify the header multiple times for each beta.
[​](https://docs.claude.com/en/api/skills/create-skill-version#parameter-anthropic-version)
anthropic-version
string
required
...
[​](https://docs.claude.com/en/api/skills/create-skill-version#parameter-x-api-key)
x-api-key
string
required
...
#### Path Parameters
[​](https://docs.claude.com/en/api/skills/create-skill-version#parameter-skill-id)
skill_id
string
required
...
#### Body
multipart/form-data
[​](https://docs.claude.com/en/api/skills/create-skill-version#body-files)
files
file[] | null
...
application/json
Successful Response
[​](https://docs.claude.com/en/api/skills/create-skill-version#response-created-at)
created_at
string
required
...
[​](https://docs.claude.com/en/api/skills/create-skill-version#response-description)
description
string
required
...
[​](https://docs.claude.com/en/api/skills/create-skill-version#response-directory)
directory
string
required
...
Examples:
`"my-skill"`
[​](https://docs.claude.com/en/api/skills/create-skill-version#response-id)
id
string
required
...
[​](https://docs.claude.com/en/api/skills/create-skill-version#response-name)
name
string
required
...
Examples:
`"my-skill"`
[​](https://docs.claude.com/en/api/skills/create-skill-version#response-skill-id)
skill_id
string
required
...
[​](https://docs.claude.com/en/api/skills/create-skill-version#response-type)
type
string
...
[​](https://docs.claude.com/en/api/skills/create-skill-version#response-version)
version
string
required
...
YesNo
[Delete Skill](https://docs.claude.com/en/api/skills/delete-skill)[List Skill Versions](https://docs.claude.com/en/api/skills/list-skill-versions)
Assistant
