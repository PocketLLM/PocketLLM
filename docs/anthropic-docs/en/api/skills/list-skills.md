# List Skills - Claude Docs> Source: https://docs.claude.com/en/api/skills/list-skillsAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
#### Headers
[​](https://docs.claude.com/en/api/skills/list-skills#parameter-anthropic-beta)
anthropic-beta
string[]
Optional header to specify the beta version(s) you want to use.
To use multiple betas, use a comma separated list like `beta1,beta2` or specify the header multiple times for each beta.
[​](https://docs.claude.com/en/api/skills/list-skills#parameter-anthropic-version)
anthropic-version
string
required
...
[​](https://docs.claude.com/en/api/skills/list-skills#parameter-x-api-key)
x-api-key
string
required
...
#### Query Parameters
[​](https://docs.claude.com/en/api/skills/list-skills#parameter-page)
page
string | null
Pagination token for fetching a specific page of results.
Pass the value from a previous response's `next_page` field to get the next page of results.
[​](https://docs.claude.com/en/api/skills/list-skills#parameter-limit)
limit
integer
default:20
Number of results to return per page.
Maximum value is 100. Defaults to 20.
[​](https://docs.claude.com/en/api/skills/list-skills#parameter-source)
source
string | null
...
application/json
Successful Response
[​](https://docs.claude.com/en/api/skills/list-skills#response-data)
data
Skill · object[]
required
List of skills.
Show child attributes
[​](https://docs.claude.com/en/api/skills/list-skills#response-has-more)
has_more
boolean
required
Whether there are more results available.
If `true`, there are additional results that can be fetched using the `next_page` token.
[​](https://docs.claude.com/en/api/skills/list-skills#response-next-page)
next_page
string | null
required
...
YesNo
[Create Skill](https://docs.claude.com/en/api/skills/create-skill)[Get Skill](https://docs.claude.com/en/api/skills/get-skill)
Assistant
