# Retrieve a Message Batch - Claude Docs> Source: https://docs.claude.com/en/api/retrieving-message-batchesAgent Skills are now available! [Learn more about extending Claude's capabilities with Agent Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview).
...
#### Headers
[​](https://docs.claude.com/en/api/retrieving-message-batches#parameter-anthropic-beta)
anthropic-beta
string[]
Optional header to specify the beta version(s) you want to use.
To use multiple betas, use a comma separated list like `beta1,beta2` or specify the header multiple times for each beta.
[​](https://docs.claude.com/en/api/retrieving-message-batches#parameter-anthropic-version)
anthropic-version
string
required
...
[​](https://docs.claude.com/en/api/retrieving-message-batches#parameter-x-api-key)
x-api-key
string
required
...
#### Path Parameters
[​](https://docs.claude.com/en/api/retrieving-message-batches#parameter-message-batch-id)
message_batch_id
string
required
...
application/json
Successful Response
[​](https://docs.claude.com/en/api/retrieving-message-batches#response-archived-at)
archived_at
...
[​](https://docs.claude.com/en/api/retrieving-message-batches#response-cancel-initiated-at)
cancel_initiated_at
string<date-time> | null
required
...
Examples:
`"2024-08-20T18:37:24.100435Z"`
[​](https://docs.claude.com/en/api/retrieving-message-batches#response-created-at)
created_at
string<date-time>
required
...
Examples:
`"2024-08-20T18:37:24.100435Z"`
[​](https://docs.claude.com/en/api/retrieving-message-batches#response-ended-at)
ended_at
string<date-time> | null
required
...
Examples:
`"2024-08-20T18:37:24.100435Z"`
[​](https://docs.claude.com/en/api/retrieving-message-batches#response-expires-at)
expires_at
string<date-time>
required
...
Examples:
`"2024-08-20T18:37:24.100435Z"`
[​](https://docs.claude.com/en/api/retrieving-message-batches#response-id)
id
string
required
...
[​](https://docs.claude.com/en/api/retrieving-message-batches#response-processing-status)
processing_status
enum<string>
required
...
`canceling`,
`ended`
[​](https://docs.claude.com/en/api/retrieving-message-batches#response-request-counts)
request_counts
object
required
...
[​](https://docs.claude.com/en/api/retrieving-message-batches#response-results-url)
results_url
string | null
required
...
[​](https://docs.claude.com/en/api/retrieving-message-batches#response-type)
type
string
...
YesNo
[Create a Message Batch](https://docs.claude.com/en/api/creating-message-batches)[Retrieve Message Batch Results](https://docs.claude.com/en/api/retrieving-message-batch-results)
Assistant
