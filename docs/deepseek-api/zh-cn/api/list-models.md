# 列出模型 | DeepSeek API Docs> Source: https://api-docs.deepseek.com/zh-cn/api/list-models[跳到主要内容](https://api-docs.deepseek.com/zh-cn/api/list-models#__docusaurus_skipToContent_fallback)
...
## Responses[​](https://api-docs.deepseek.com/zh-cn/api/list-models#responses "Responses的直接链接")
  * 200
...
Loading...
[上一页 FIM 补全（Beta）](https://api-docs.deepseek.com/zh-cn/api/create-completion)[下一页 查询余额](https://api-docs.deepseek.com/zh-cn/api/get-user-balance)
微信公众号
