# 限速 | DeepSeek API Docs> Source: https://api-docs.deepseek.com/zh-cn/quick_start/rate_limit[跳到主要内容](https://api-docs.deepseek.com/zh-cn/quick_start/rate_limit#__docusaurus_skipToContent_fallback)
...
[上一页 Token 用量计算](https://api-docs.deepseek.com/zh-cn/quick_start/token_usage)[下一页 错误码](https://api-docs.deepseek.com/zh-cn/quick_start/error_codes)
微信公众号
