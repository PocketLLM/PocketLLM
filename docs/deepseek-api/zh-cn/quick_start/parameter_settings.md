# Temperature 设置 | DeepSeek API Docs> Source: https://api-docs.deepseek.com/zh-cn/quick_start/parameter_settings[跳到主要内容](https://api-docs.deepseek.com/zh-cn/quick_start/parameter_settings#__docusaurus_skipToContent_fallback)
...
[](https://api-docs.deepseek.com/zh-cn/quick_start/parameter_settings)
  ...
  * [中文（中国）](https://api-docs.deepseek.com/zh-cn/quick_start/parameter_settings)
...
翻译 | 1.3  
创意类写作/诗歌创作 | 1.5  
[上一页 模型 & 价格](https://api-docs.deepseek.com/zh-cn/quick_start/pricing)[下一页 Token 用量计算](https://api-docs.deepseek.com/zh-cn/quick_start/token_usage)
微信公众号
