# Function Calling | DeepSeek API Docs> Source: https://api-docs.deepseek.com/zh-cn/guides/function_calling[跳到主要内容](https://api-docs.deepseek.com/zh-cn/guides/function_calling#__docusaurus_skipToContent_fallback)
...
* * *
## 样例代码[​](https://api-docs.deepseek.com/zh-cn/guides/function_calling#%E6%A0%B7%E4%BE%8B%E4%BB%A3%E7%A0%81 "样例代码的直接链接")
这里以获取用户当前位置的天气信息为例，展示了使用 Function Calling 的完整 Python 代码。
Function Calling 的具体 API 格式请参考[对话补全](https://api-docs.deepseek.com/zh-cn/api/create-chat-completion/)文档。
```
...
* * *
##  `strict` 模式（Beta）[​](https://api-docs.deepseek.com/zh-cn/guides/function_calling#strict-%E6%A8%A1%E5%BC%8Fbeta "strict-模式beta的直接链接")
...
* * *
###  `strict` 模式支持的 JSON Schema 类型[​](https://api-docs.deepseek.com/zh-cn/guides/function_calling#strict-%E6%A8%A1%E5%BC%8F%E6%94%AF%E6%8C%81%E7%9A%84-json-schema-%E7%B1%BB%E5%9E%8B "strict-模式支持的-json-schema-类型的直接链接")
  * object
  * string
  * number
  * integer
...
* * *
#### object 类型[​](https://api-docs.deepseek.com/zh-cn/guides/function_calling#object-%E7%B1%BB%E5%9E%8B "object 类型的直接链接")
...
* * *
#### string 类型[​](https://api-docs.deepseek.com/zh-cn/guides/function_calling#string-%E7%B1%BB%E5%9E%8B "string 类型的直接链接")
  * 支持的参数：
...
* * *
#### number/integer 类型[​](https://api-docs.deepseek.com/zh-cn/guides/function_calling#numberinteger-%E7%B1%BB%E5%9E%8B "number/integer 类型的直接链接")
  * 支持的参数
    * const：固定数字为常数
    * default：数字的默认值
    * minimum：最小值
...
* * *
#### array 类型[​](https://api-docs.deepseek.com/zh-cn/guides/function_calling#array-%E7%B1%BB%E5%9E%8B "array 类型的直接链接")
  * 不支持的参数
    * minItems
    * maxItems
...
* * *
#### enum[​](https://api-docs.deepseek.com/zh-cn/guides/function_calling#enum "enum的直接链接")
...
* * *
#### anyOf[​](https://api-docs.deepseek.com/zh-cn/guides/function_calling#anyof "anyOf的直接链�接")
...
* * *
#### $ref 和 $def[​](https://api-docs.deepseek.com/zh-cn/guides/function_calling#ref-%E5%92%8C-def "$ref 和 $def的直接链接")
...
[上一页 JSON Output](https://api-docs.deepseek.com/zh-cn/guides/json_mode)[下一页 上下文硬盘缓存](https://api-docs.deepseek.com/zh-cn/guides/kv_cache)
  * [样例代码](https://api-docs.deepseek.com/zh-cn/guides/function_calling#%E6%A0%B7%E4%BE%8B%E4%BB%A3%E7%A0%81)
  * [`strict` 模式（Beta）](https://api-docs.deepseek.com/zh-cn/guides/function_calling#strict-%E6%A8%A1%E5%BC%8Fbeta)
    * [`strict` 模式支持的 JSON Schema 类型](https://api-docs.deepseek.com/zh-cn/guides/function_calling#strict-%E6%A8%A1%E5%BC%8F%E6%94%AF%E6%8C%81%E7%9A%84-json-schema-%E7%B1%BB%E5%9E%8B)
