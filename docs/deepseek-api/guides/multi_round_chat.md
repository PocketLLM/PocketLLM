# Multi-round Conversation | DeepSeek API Docs> Source: https://api-docs.deepseek.com/guides/multi_round_chat[Skip to main content](https://api-docs.deepseek.com/guides/multi_round_chat#__docusaurus_skipToContent_fallback)
...
[Previous Reasoning Model (deepseek-reasoner)](https://api-docs.deepseek.com/guides/reasoning_model)[Next Chat Prefix Completion (Beta)](https://api-docs.deepseek.com/guides/chat_prefix_completion)
