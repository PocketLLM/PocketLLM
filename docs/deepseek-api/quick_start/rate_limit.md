# Rate Limit | DeepSeek API Docs> Source: https://api-docs.deepseek.com/quick_start/rate_limit[Skip to main content](https://api-docs.deepseek.com/quick_start/rate_limit#__docusaurus_skipToContent_fallback)
...
[](https://api-docs.deepseek.com/quick_start/rate_limit)
  * [English](https://api-docs.deepseek.com/quick_start/rate_limit)
  * [中文（中国）](https://api-docs.deepseek.com/zh-cn/quick_start/rate_limit)
...
[Previous Token & Token Usage](https://api-docs.deepseek.com/quick_start/token_usage)[Next Error Codes](https://api-docs.deepseek.com/quick_start/error_codes)
