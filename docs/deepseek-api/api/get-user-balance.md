# Get User Balance | DeepSeek API Docs> Source: https://api-docs.deepseek.com/api/get-user-balance[Skip to main content](https://api-docs.deepseek.com/api/get-user-balance#__docusaurus_skipToContent_fallback)
...
Loading...
[Previous Lists Models](https://api-docs.deepseek.com/api/list-models)[Next Reasoning Model (deepseek-reasoner)](https://api-docs.deepseek.com/guides/reasoning_model)
